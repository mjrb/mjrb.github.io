...
var line = cljs.core.get.call(null,map__27628__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27628__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e27627){var _e = e27627;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___27630 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___27630)){
var seen_errors_27631 = temp__5455__auto___27630;
if(cljs.core.truth_(seen_errors_27631.has(self))){
} else {
seen_errors_27631.add(self);

var temp__5457__auto___27632 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___27632)){
var sense_27633 = temp__5457__auto___27632;
...
//# sourceMappingURL=hints.js.map?rel=1527787696276
