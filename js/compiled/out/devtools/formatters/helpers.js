...
var G__27852 = devtools.prefs.pref.call(null,v);
v = G__27852;
continue;
} else {
return v;
...
}catch (e27855){var _e__27598__auto__ = e27855;
return false;
}})();
...
}catch (e27859){var _e__27598__auto__ = e27859;
return false;
}})();
...
}catch (e27861){var _e__27598__auto__ = e27861;
return false;
}}
}
});
...
var vec__27863 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27863,(0),null);
var name = cljs.core.nth.call(null,vec__27863,(1),null);
...
return cljs.core.some.call(null,(function (p1__27866_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27866_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1527787696604
