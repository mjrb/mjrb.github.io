...
var o27750 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27750["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27751 = temp__5455__auto____$1;
return (o27751["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27591__auto__ = f;
return (o__27591__auto__["toString"]).call(o__27591__auto__);
} else {
return "";
}
}catch (e27752){var _ = e27752;
return "";
}});
...
try{var o__27591__auto___27754 = t;
(o__27591__auto___27754["cljs$lang$ctorPrWriter"]).call(o__27591__auto___27754,t,writer);
}catch (e27753){var __27755 = e27753;
}
...
var char_code = (function (){var o__27591__auto__ = (new String(char$));
return (o__27591__auto__["charCodeAt"]).call(o__27591__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27591__auto__ = String;
return (o__27591__auto__["fromCharCode"]).call(o__27591__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27756 = num_code;
switch (G__27756) {
case (1):
return (185);
...
var o__27591__auto__ = String;
return (o__27591__auto__["fromCharCode"]).call(o__27591__auto__,superscript_code);
});
/**
...
}catch (e27758){var _e__27598__auto__ = e27758;
return false;
}})())){
...
var vec__27759 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27759,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o27762 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27762["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27763 = temp__5455__auto____$1;
return (o27763["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27766){
var vec__27767 = p__27766;
var ns_detector = cljs.core.nth.call(null,vec__27767,(0),null);
...
var G__27773 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27774 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27773;
remaining_tokens = G__27774;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27764){
var G__27765 = cljs.core.first.call(null,seq27764);
var seq27764__$1 = cljs.core.next.call(null,seq27764);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27765,seq27764__$1);
});
...
var vec__27778 = cljs.core.split_with.call(null,(function (p1__27777_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27777_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27778,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27778,(1),null);
...
var vec__27781 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27781,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27781,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27784 = cljs.core.rest.call(null,remaining_tokens);
var G__27785 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27784;
name_tokens = G__27785;
continue;
} else {
...
var vec__27788 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27788,(0),null);
var arity = cljs.core.nth.call(null,vec__27788,(1),null);
var vec__27791 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27791,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27791,(1),null);
var vec__27794 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27794,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27794,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27794,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27794,(3),null);
...
var vec__27800 = result;
var munged_ns = cljs.core.nth.call(null,vec__27800,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27800,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27800,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27800,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27800,(4),null);
var arity = cljs.core.nth.call(null,vec__27800,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27804 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27804,(0),null);
var args = cljs.core.nth.call(null,vec__27804,(1),null);
var vec__27807 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27807,(0),null);
var name = cljs.core.nth.call(null,vec__27807,(1),null);
...
var G__27810 = (arity + (1));
var G__27811 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27812){
var vec__27813 = p__27812;
var arity = cljs.core.nth.call(null,vec__27813,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27813,(1),null);
...
return cljs.core.get.call(null,arities,p1__27816_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27817_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___27824 = arguments.length;
var i__4500__auto___27825 = (0);
while(true){
if((i__4500__auto___27825 < len__4499__auto___27824)){
args__4502__auto__.push((arguments[i__4500__auto___27825]));

var G__27826 = (i__4500__auto___27825 + (1));
i__4500__auto___27825 = G__27826;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27820){
var vec__27821 = p__27820;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27821,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27818){
var G__27819 = cljs.core.first.call(null,seq27818);
var seq27818__$1 = cljs.core.next.call(null,seq27818);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27819,seq27818__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27829__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27829__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27829__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27829__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27830 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27830,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27830,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27830,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27830,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27830,(4),null);
var arity = cljs.core.nth.call(null,vec__27830,(5),null);
...
var o__27591__auto__ = f;
return (o__27591__auto__["getBasis"]).call(o__27591__auto__);
});
/**
...
}catch (e27834){var _e__27598__auto__ = e27834;
...
var G__27835 = (obj[cljs.core.first.call(null,path)]);
var G__27836 = cljs.core.rest.call(null,path);
obj = G__27835;
path = G__27836;
continue;
} else {
...
return (function (accum,p__27837){
var vec__27838 = p__27837;
var bit = cljs.core.nth.call(null,vec__27838,(0),null);
var protocol = cljs.core.nth.call(null,vec__27838,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27841){
var vec__27842 = p__27841;
var ns = cljs.core.nth.call(null,vec__27842,(0),null);
var name = cljs.core.nth.call(null,vec__27842,(1),null);
var selector = cljs.core.nth.call(null,vec__27842,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27847,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27847,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27847,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27845_SHARP_){
return (obj[cljs.core.first.call(null,p1__27845_SHARP_)]);
});})(name,sorted_matches,vec__27847,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1527787696541
