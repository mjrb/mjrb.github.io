...
var G__24251 = o;
(G__24251[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__24252__delegate = function (args){
...
while (G__24253__i < G__24253__a.length) {G__24253__a[G__24253__i] = arguments[G__24253__i + 0]; ++G__24253__i;}
  args = new cljs.core.IndexedSeq(G__24253__a,0,null);
} 
return G__24252__delegate.call(this,args);};
G__24252.cljs$lang$maxFixedArity = 0;
G__24252.cljs$lang$applyTo = (function (arglist__24254){
var args = cljs.core.seq(arglist__24254);
return G__24252__delegate(args);
});
...
var G__24257 = jsprops;
(G__24257["defaultValue"] = value);

(G__24257["onChange"] = ((function (G__24257,v,value,on_change){
return (function (p1__24256_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24256_SHARP_);
});})(G__24257,v,value,on_change))
);
...
var vec__24260 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24260,(0),null);
var id = cljs.core.nth.call(null,vec__24260,(1),null);
var class$ = cljs.core.nth.call(null,vec__24260,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___24264 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___24264 == null)){
} else {
var key_24265 = temp__5461__auto___24264;
(jsprops["key"] = key_24265);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24266 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24266["name"] = c);
...
var len__4499__auto___24271 = arguments.length;
var i__4500__auto___24272 = (0);
while(true){
if((i__4500__auto___24272 < len__4499__auto___24271)){
args__4502__auto__.push((arguments[i__4500__auto___24272]));

var G__24273 = (i__4500__auto___24272 + (1));
i__4500__auto___24272 = G__24273;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24269){
var G__24270 = cljs.core.first.call(null,seq24269);
var seq24269__$1 = cljs.core.next.call(null,seq24269);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24270,seq24269__$1);
});
...
break;
default:
var G__24276 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24276;
continue;
...
var n__4376__auto___24278 = a.length;
var i_24279 = (0);
while(true){
if((i_24279 < n__4376__auto___24278)){
(a[i_24279] = reagent.impl.template.as_element.call(null,(a[i_24279])));

var G__24280 = (i_24279 + (1));
i_24279 = G__24280;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___24281 = a.length;
var i_24282 = (0);
while(true){
if((i_24282 < n__4376__auto___24281)){
var val_24283 = (a[i_24282]);
if(((cljs.core.vector_QMARK_.call(null,val_24283)) && ((reagent.impl.template.key_from_vec.call(null,val_24283) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24282] = reagent.impl.template.as_element.call(null,val_24283));

var G__24284 = (i_24282 + (1));
i_24282 = G__24284;
continue;
} else {
}
...
var ctx = ({});
var vec__24285 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24285,(0),null);
var derefed = cljs.core.nth.call(null,vec__24285,(1),null);
...
var G__24288 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24288) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24288){
...
//# sourceMappingURL=template.js.map?rel=1527787693913
